...
// }, [])
  ...
  return (
    <div >
      <h1 className="text-4xl mt-24  flex justify-center">Dsa Questions</h1>
      <h3 className="text-4xl mt-3 text-purple-800 align-items-center text-center  flex justify-center">
        Crack today problem of the companies 
      </h3>
      ...
      <div className="mb-10">
        <div className="flex justify-center ">
          ...
          <Link
            ...
            to="https://www.linkedin.com/in/kotapati-lakshmareddy-536a8721a"
          >
            {" "}
            kotapati lakshmareddy &nbsp;
          </Link>
        ...
        <div className="flex justify-center">
          ...
          <Link
            ...
            to="https://github.com/kotapati7396"
          >
            &nbsp; Github \ KNLR{" "}
          </Link>
        </div>
